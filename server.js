    ...
    if (pendingVideos.length > 0) {
      ...
      try {
        const notice = await bot.sendMessage(
          userId,
          "⚠️ <b>Lectures deleted</b>\n\nAapne required Force Join channel/group leave kar diya tha, isliye bot se bheje gaye lectures delete kar diye gaye hain.\n\nDobara lectures ke liye pehle required channel/group join karein.\n\n⏳ Yeh notice 6 hours baad khud delete ho jayega.",
          { parse_mode: "HTML" }
        );
